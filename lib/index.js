...
const selectTag = function(props, defaultTag, context, blockProps, component) {
  const tag = (typeof defaultTag === 'function' && !React.Component.isPrototypeOf(defaultTag)) ? defaultTag(blockProps, component.state, component) : defaultTag;
...
bemto.elem = function(block, elemName, tagString, options) {
  ...
  return class Bemto extends React.Component {
    render(){
      const props = {};
      props.__BemtoElem = {
        name: elemName,
