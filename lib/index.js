...
const bemto = function(tagString) {
  ...
  const bemtoFactory = class bemtoTag extends React.Component {
    render(){
      ...
      const parsedTagString = elem ? (elem.parsedTagString || parseTagString(elem.tagString || '')) : parsedBlockTagString;
      const props = {};
      ...
      return React.createElement(selectTag(props, parsedTagString.tag), props, this.props.children);
    }
  };
